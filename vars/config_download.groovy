def call(client_name,classname) {
  ...
  dir ("config") {
      ...
      hedgingConfiguration = downloadFileFromS3(awsCredentials,  "${conf.configurationS3Url}/${params.client_name.toUpperCase()}/${params.client_name.toUpperCase()}_config-update.json.gz", configRoot)
